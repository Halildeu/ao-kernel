...
- **V5 readiness manifest drift guard**: clarified the governed-control-plane
  ...
  `ready_for_operator_decision`, and added an invariant test preventing
  completed RI-7 evidence rows from reappearing as next-work blockers. This is
  documentation/test hardening only; it does not tag or publish v5.0.0, widen
  support, claim production-platform readiness, execute live adapters, or
  change guard flags.
