...
def test_release_gate_denies_stale_branch() -> None:
    decision = build_ao_release_gate_decision(_stale_branch_payload(), _gpp_status())
...
def test_release_gate_denies_untrusted_fork_context() -> None:
    decision = build_ao_release_gate_decision(_untrusted_context_payload(), _gpp_status())
...
def test_release_gate_denies_missing_ci_evidence() -> None:
    decision = build_ao_release_gate_decision(_missing_evidence_payload(), _gpp_status())
...
def test_release_gate_denies_policy_violations() -> None:
    decision = build_ao_release_gate_decision(_policy_violation_payload(), _gpp_status())
...
def test_check_run_conclusion_mapping(
    ...
    """
    shadow = build_ao_release_gate_decision(payload_factory(), _gpp_status())
    ...
    enforce = build_ao_release_gate_decision(payload_factory(), _gpp_status(), conclusion_mode="enforce")
